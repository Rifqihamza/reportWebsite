                    ...
                    <div className="w-full h-full px-4 py-6 rounded-2xl border border-gray-300 bg-white shadow-inner shadow-gray-100">
                        ...
                        <div className="text-gray-600">{!insight ? "Insights masih dalam pengerjaan" : 
                            <ol className="list-decimal m-4">
                                ...
                                <li>{insight.notCompletedReportPreviousMonth > 0 ? <>Ada <b>{insight.notCompletedReportPreviousMonth.toString() + " laporan temuan yang belum terselesaikan di bulan lalu. Itu sekitar" + (insight.notCompletedReportPreviousMonth * 100 / insight.totalReportAllTime).toString() + "% dari seluruh laporan!"}</b></> : <b>Semua temuan bulan lalu sudah terselesaikan semua!</b>}/</li>
                            </ol>}
                        </div>
                    </div>
                </div>
