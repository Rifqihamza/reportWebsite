...
export default function ApplyFilterButton() {
  ...
  return <>
    <button 
      className={`w-full h-fit py-3 bg-white text-[#495057] font-bold rounded-lg cursor-pointer hover:brightness-75 disabled:opacity-50 disabled:brightness-75 disabled:cursor-not-allowed`}
      onClick={() => applyFilter()}
      disabled={!isChange}
    >
      Terapkan Filter
