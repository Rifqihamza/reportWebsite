        ...
        <div className="flex flex-col gap-4 mx-4 mt-2">
          ...
          <div className="w-full px-4 pb-2 pt-6 rounded-2xl bg-[#2b3440] border border-white shadow">
            ...
            <Suspense fallback={<>Loading..</>}>
              <LineChartComponent
                reports={lineChartFilteredReports}
                colors={lineChartCategoryFilter ? [statusColorHex[reporttype_to_string(lineChartCategoryFilter)]] : Object.values(ReportType).map((type) => statusColorHex[reporttype_to_string(type)])}
              />
            </Suspense>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 w-full">
            ...
            <div className="flex flex-col gap-4 w-full">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <Suspense fallback={<>Loading..</>}>
                  <PercenComponent reports={percentStatus} label="Status" />
                </Suspense>
                <Suspense fallback={<>Loading..</>}>
                  <PercenComponent reports={percentCategory} label="Kategori" />
                </Suspense>
              </div>
