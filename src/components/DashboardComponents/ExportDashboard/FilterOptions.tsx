...
export default function FilterOptions() {
  ...
  return <>
    <div className="bg-[#1f324d] rounded-xl w-full min-h-48 lg:h-full shadow-sm shadow-gray-400 col-span-3 row-span-2 row-start-2 col-start-3 flex flex-col relative">
      ...
      <div className="bg-[#ededed] h-full rounded-xl flex justify-center p-2  overflow-auto">
        <Accordion activeIndex={0} className="w-full">
          {Object.entries(filterOptions).map(([key, options]) => {
            ...
            return <AccordionTab header={capitalize(key)} className="flex flex-col">
