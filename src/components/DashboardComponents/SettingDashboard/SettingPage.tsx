  ...
  return (
    <>
      ...
      <section className="flex md:flex-row flex-col gap-4 w-full rounded-2xl p-6">
        {/* Data Profile */}
        <div className="w-full flex flex-row items-center gap-8 bg-[#257180] shadow shadow-gray-500 rounded-2xl px-8 py-6">
          ...
          <ul className="flex flex-col w-full text-[#F2E5BF]">
            {/* Username */}
            <li className="flex flex-row gap-2 md:gap-6 items-center w-full p-2 md:p-8 cursor-pointer hover:bg-[#cb6040] hover:rounded-xl duration-300" onClick={() => setEditKey("username")}>
            ...
            {/* Password */}
            <li className="flex flex-row gap-2 md:gap-6 items-center w-full p-2 md:p-8 cursor-pointer hover:bg-[#cb6040] hover:rounded-xl duration-300" onClick={() => setEditKey("password")}>
              <div className="w-full">
