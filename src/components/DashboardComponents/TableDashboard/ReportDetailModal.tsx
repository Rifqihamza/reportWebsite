...
export default function ReportDetailModal() {
    ...
    return (
        <>
            ...
            {/* Modal content */}
            <div className={(detailId ? "visible pointer-events-auto top-0 scale-100" : "invisible pointer-events-none top-0 scale-80 opacity-0") +
                " left-1/2 -translate-x-1/2 translate-y-[3rem] duration-300 ease-in-out fixed bg-white w-full max-w-[90vw] lg:max-w-[85vw] h-fit " +
                "lg:max-h-[100vh] max-h-[90vh] px-4 p-8 rounded-3xl z-50 flex flex-col space-y-5"}>
