        ...
        <div className="flex flex-col md:flex-row items-center gap-4">
          <div className="relative w-full flex items-center gap-4">
            <input
              ...
              className={`w-full pl-10 pr-13 py-3 rounded-xl placeholder-white! bg-[#CB6040] outline-none ${searchKeyword.length > 0 ? "text-white" : ""}`}
          ...
          <div className="flex flex-row gap-3 items-center">
            ...
            <Calendar
              className={`w-fit h-full *:cursor-pointer *:placeholder:text-white! [&_.p-inputtext]:py-3! [&_.p-inputtext]:bg-[#257180]! [&_.p-inputtext]:text-white! ${dateFilter[0] ? " " : ""}`}
              inputId="from-date"
            ...
            <Calendar
              className={`w-fit h-full *:cursor-pointer *:placeholder:text-white! [&_.p-inputtext]:py-3! [&_.p-inputtext]:bg-[#257180]! [&_.p-inputtext]:text-white! ${dateFilter[1] ? " " : ""}`}
              inputId="until-date"
