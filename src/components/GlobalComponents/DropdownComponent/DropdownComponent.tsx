...
export default function DropdownComponent(props: Props) {
  return <>
      <Dropdown
        ...
        panelClassName="[&_.p-dropdown-header]:rounded-lg! rounded-lg! [&_.p-dropdown-filter]:placeholder:text-white! [&_.p-dropdown-filter]:placeholder:opacity-50 [&_.p-dropdown-header]:bg-[#fd8b51]! [&_.p-dropdown-header]:**:text-white! [&_.p-dropdown-header]:**:bg-[#1a1d24]! [&_.p-focus]:bg-[#fd8b51]! [&_.p-dropdown-item]:hover:bg-[#1a1d24]! [&_.p-dropdown-item]:hover:text-white! [&_.p-highlight]:bg-[#1a1d24]!"
