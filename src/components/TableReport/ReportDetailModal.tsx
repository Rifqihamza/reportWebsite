            ...
            <div className={(detailId ? "visible pointer-events-auto bottom-0" : "invisible pointer-events-none -bottom-[50rem]") +
                ...
                <div className="mt-4 flex flex-col md:flex-row gap-6 mx-4 h-full overflow-auto">
                    ...
                    <div className="space-y-2 w-full flex flex-col">
                        ...
                        <DetailField label="Lokasi:" value={report_data?.location} />
                        <DetailField label="Kategori:" value={report_data ? reporttype_to_string(report_data.type) : "N/A"} />
                        ...
                        <DetailField label="Due Date:" value={formatDate(report_data?.due_date)} fallback="Belum ditentukan" />
