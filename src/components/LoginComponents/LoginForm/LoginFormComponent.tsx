  ...
  return (
    <>
      ...
      <div className="space-y-2 mt-8">
        <button
          type="button"
          className={`disabled:opacity-50 w-full uppercase tracking-[2px] font-bold px-6 py-2 rounded-xl bg-[var(--primary)] text-white hover:opacity-80 duration-200 cursor-pointer`}
